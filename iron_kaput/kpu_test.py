...
if __name__ == "__main__":
    try:
        ...
        #main(model_addr="/sd/model-196410.kmodel", lcd_rotation=0, sensor_hmirror=False, sensor_vflip=True)
        #main(model_addr="/sd/facedetect.kmodel", lcd_rotation=0, sensor_hmirror=False, sensor_vflip=True)
    except Exception as e:
